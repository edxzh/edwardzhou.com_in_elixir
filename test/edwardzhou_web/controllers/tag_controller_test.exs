defmodule EdwardzhouWeb.TagControllerTest do
  use EdwardzhouWeb.ConnCase

  import Edwardzhou.BlogFixtures

  @create_attrs %{name: "some name", publish_status: :published, uuid: "7488a646-e31f-11e4-aace-600308960662"}
  @update_attrs %{name: "some updated name", publish_status: :drafted, uuid: "7488a646-e31f-11e4-aace-600308960668"}
  @invalid_attrs %{name: nil, publish_status: nil, uuid: nil}
